...
public class DepartamentController {
   ...
   @PostConstruct
	public void init(){
	   setDepartaments(departamentRepository.finAll());
	}
	...
	public DepartamentRepository getDepartamentRepository() {
		return departamentRepository;
	}

	public void setDepartamentRepository(DepartamentRepository departamentRepository) {
